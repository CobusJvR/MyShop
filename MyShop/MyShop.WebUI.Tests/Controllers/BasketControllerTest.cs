...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "cobusjvr@invantage.co.za", ZipCode = "90210" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("cobusjvr@invantage.co.za","Forms"),null);
